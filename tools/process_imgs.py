...
for filename in os.listdir(original_path):
    ...
    if os.path.isfile(file_path):
        ...
        subprocess.call("python " + os.path.join(os.path.dirname(os.path.realpath(__file__)), 'generate.py') + " --haov 360.0 --fallbacksize 0 --vaov 180.0 " + str(img_file) + " -q 70 -o " + directory + "/img/" + image_id, shell=True)
        file_count += 1
